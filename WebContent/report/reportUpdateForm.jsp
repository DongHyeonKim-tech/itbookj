		...
		<div class="container">
			<form name="frm" method="post"
				...
				<div class="row mt-5">
					...
					<div class="col-md-12">
						<div class="form-group">
							<span class="form-group"> 도서명 <input type="text"
								value="${reportList.bookTitle}" class="form-control"
								placeholder="도서명" onclick="openPopUp()" name="bookTitle" id="bookTitle" disabled></span>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							<span class="form-group"> 저자<input type="text"
								class="form-control" placeholder="저자"
								value="${reportList.writer}" readonly="readonly" name="writer" id="writer" disabled></span>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<span class="form-group"> 출판사<input type="text"
								class="form-control" placeholder="출판사"
								value="${reportList.publisher}" readonly="readonly"
								name="publisher" id="publisher" disabled></span>
						</div>
					</div>
					...
					<div class="col-md-12">
						<span class="form-group">제목<input type="text"
							...
							value="${reportList.reportTitle}" name="reportTitle" id="reportTitle"></span>
					</div>

					<div class="col-md-12" style="min-height: 480px;">
						<div class="wrap">
							<textarea cols="40" rows="20" name="reportContent"
								class="form-control" id="reportContent" placeholder="내용을 입력하세요.">${reportList.reportContent}</textarea>
					...
					<div class="col-md-12 text-right">
						<button type="submit"
							...
							onclick="return reportCheck()">수정</button>
