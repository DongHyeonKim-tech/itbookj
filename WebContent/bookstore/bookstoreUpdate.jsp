			...
			<div class="row" style="justify-content: center;">
				<div class="col-lg-12">
					...
					<form name="frm" method="post"
						...
						<h4 class="text-center mb-4">책방 수정</h4>
						<div class="col-md-9 text-left mx-auto align-items-center">
						<div class="form-group">
							<label><span style="color: red;">*</span>책방이름</label> <input class="form-control" type="text"
						...
						<div class="form-group">
						<label><span style="color: red;">*</span>기존 주소 : ${bookstoreList.bookstoreContent}</label>
                  		<input type="button" onclick="sample4_execDaumPostcode()" class ="btn btn-dark" value="주소 찾기" ><br>
               
               	<input type="hidden" id="sample4_postcode"   name = "adr1" placeholder="우편번호" class="form-control" style ="width:150px" readonly="readonly"> 
               	<input type="text" id="sample4_roadAddress"  value = "${bookstoreList.bookstoreContent}" name = "bookstoreContent" id = "adr" placeholder="도로명주소" class="form-control" readonly="readonly">
