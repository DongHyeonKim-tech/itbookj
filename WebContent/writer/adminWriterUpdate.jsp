			...
			<div class="row">
				<div class="col-lg-12">
					<form name="frm" method="post" role="form"
						action="writer?command=adminWriterUpdate"
						...
						<h4 class="text-center mb-4">대전 작가 수정</h4>
						<br>
						<div class="row">
							<div class="form-group col-md-6">
								<span class="form-group">작가 이름<span style="color: red;">*</span></span><input
									type="text" value="${writerList.writerName}" name="writerName"
									placeholder="*작가 이름을 입력하세요" class="form-control">
							</div>
							<div class="form-group col-md-6">
								<span class="form-group">가입 협회 </span><input type="text"
									value="${writerList.association}" name="association"
									placeholder="가업 협회를 입력하세요" class="form-control">
							</div>
						</div>
							...
							<div class="col-md-12" style="min-height: 480px;">
								...
								<div class="wrap">
									<textarea cols="40" rows="20" name="writerContents"
										...
										placeholder="내용을 입력하세요. 글자 수는 1500자로 제한됩니다.">${writerList.writerContents}</textarea>
						...
						<div class="row">
							<div class="form-group col-md-12">
								<span class="form-group">대표작 <span style="color: red;">*</span></span><input
									type="text" value="${writerList.writerBook1}"
									name="writerBook1" placeholder="저술한 도서 제목을 입력하세요"
									class="form-control">
							</div>
							<div class="form-group col-md-12">
								<span class="form-group">대표작 (선택) </span> <input type="text"
									value="${writerList.writerBook2}" name="writerBook2"
						...
						<div class="row">
							<div class="form-group col-md-12">
								<span class="form-group">대표작 (선택)</span> <input type="text"
									value="${writerList.writerBook3}" name="writerBook3"
									placeholder="저술한 도서 제목을 입력하세요" class="form-control">
							</div>
							<div class="form-group col-md-12">
								<span class="form-group">대표작 (선택)</span> <input type="text"
									value="${writerList.writerBook4}" name="writerBook4"
									placeholder="저술한 도서 제목을 입력하세요" class="form-control">
							</div>

							<div class="form-group col-md-12">
								<span class="form-group">대표작 (선택)</span> <input type="text"
									value="${writerList.writerBook5}" name="writerBook5"
									placeholder="저술한 도서 제목을 입력하세요" class="form-control">
							</div>
						...
						<div class="form-group">
							<label>기존 파일</label> <input class="form-control" type="text"
								value="${writerList.imgPath}" name="existing_file"
								readonly="readonly">
						</div>
               ...
               <div class="form-group">
                  ...
                  <label>작가 이름</label> <input class="form-control" type="text" value = "${writerList.writerName}" name ="writerName"
                     placeholder="* 작가 이름을 입력하세요.">
               </div>
               
            <div class="form-group">
                  <label>가입 협회</label> <input class="form-control" type="text" value="${writerList.association}" name ="association"
                     placeholder="* 가입 협회를 입력하세요.">
               </div>
               
               
            <div class="form-group">
                  <label>대표작품</label> <input class="form-control" type="text" value="${writerList.writerBook1}" name ="writerBook1"
                     placeholder=" 작품을 입력하세요.">
                      <input class="form-control" type="text" value="${writerList.writerBook2}" name ="writerBook2"
                     placeholder=" 작품을 입력하세요.">
                      <input class="form-control" type="text" value="${writerList.writerBook3}" name ="writerBook3"
                     placeholder=" 작품을 입력하세요.">
                      <input class="form-control" type="text" value="${writerList.writerBook4}" name ="writerBook4"
                     placeholder=" 작품을 입력하세요.">
                      <input class="form-control" type="text" value="${writerList.writerBook5}" name ="writerBook5"
                     placeholder=" 작품을 입력하세요.">
               </div>
				...
				<div class="form-group">
                  <label>기존 파일</label> <input class="form-control" type="text" value = "${writerList.imgPath}" name ="existing_file" readonly="readonly">
               	</div>
               ...
               <div class="form-group">
               	...
               	<!--업로드 끝  --> --%>
												...
												<div class="row align-items-center">
													<div class="col-auto">
														<img data-dz-thumbnail=""
															class="avatar-sm rounded bg-light" src="/displayFile?fileName=${fVo.fileName}" style="white: 200px; height:200px;">
															
													</div>
													<div class="col pl-0">
														<a href="/displayFile?fileName=${fVo.fileName}" text-muted
															font-weight-bold" data-dz-name="">${fVo.fileName}</a>
													</div>
													<div class="col-auto">
														<a href="${fVo.fileName}"
						...
						<div align="right">
							<input type="submit" class="btn btn-grad"
								onclick="return writerCheck()" value="수정">
							<!-- AdminWriterUpdateAction에서 new WriterListAction를 사용하여 화면자들이 보는 리스트로 가게 함 -->
                 ...
                 삭제</button> --%>
							<button type="button" class="btn btn-grad" id="delete"
								onclick="location.href= 'writer?command=adminWriterDelete&writerNo=${writerList.writerNo}'">
								삭제</button>
...
<script>
	$(document).ready(function() {
		...
		$('#writerContents').on('keyup', function() {
	...
	$(function() {
		$('#writerContents').keyup(function(e) {
						...
						$('#delete')
								.on(
										...
										function(evt) {
											...
											if (confirmStat == true) {
												var writerNo = $('#writerNo')
														.val();
												alert("삭제되었습니다.");
												self.location = "writer?command=adminWriterDelete&writerNo=${writerList.writerNo}";
											} else {
												return false;
											}
