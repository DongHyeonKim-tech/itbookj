					...
					<form name="frm" method="post" action="library?command=libraryReg">
						...
						<div class="col-md-9 text-left mx-auto align-items-center">
							<div class="form-group">
								<label>도서관 명<span style="color: red;">*</span></label> <input
									class="form-control" type="text" name="libraryTitle"
									placeholder="도서관 명을 입력하세요.">
							</div>
							<div class="form-group">
								<label>URL<span style="color: red;">*</span></label> <input
									class="form-control" type="text" name="libraryUrl"
									placeholder="URL을 입력하세요.">
							</div>
							<div class="form-group">
								<label>도서관 위치<span style="color: red;">*</span></label>
								<!--  <input
									class="form-control" type="text" name="libraryContent"
									placeholder="위치를 입력하세요."> -->
									
									
									
									<input type="button" onclick="sample4_execDaumPostcode()"
									class="btn btn-dark" value="주소 찾기"><br> 
									<input
									type="text" id="sample4_postcode" name="adr1"
									placeholder="우편번호" class="form-control" readonly="readonly">
								<input type="text" id="sample4_roadAddress"
									name="libraryContent" id="adr" placeholder="도로명주소"
							...
							<div align="right">
								...
								<input type="button" style="margin: 0;" value="취소" id="cancel"
									class="btn btn-grad">
							</div>
						</div>
					</form>
