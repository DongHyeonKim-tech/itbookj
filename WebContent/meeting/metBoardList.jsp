		...
		<div class="container">
			<div class="row all-text-white">
				<div class="col-md-12 align-self-center">
					<h1 class="innerpage-title">${meetingVo.metName} 게시판 </h1>
            ...
            <div class="col-sm-12 mb-5">
               ...
               <div class="table-responsive-sm">
                  ...
                  <a  class="btn btn-grad" href="meeting?command=metBoardWriteFormAction&metNum=${meetingVo.metNum }" >글쓰기</a>
                   <a  class="btn btn-grad" href="/meeting?command=meetingHome&metNum=${meetingVo.metNum}" style = "text-align: lift;">뒤로가기</a>
                  </div>
							...
							<ul class="pagination justify-content-center">
								<c:if test="${paging.pageNum > 1}">
									<li class="page-item"><a class="page-link"
										href="meeting?command=metBoardListFormAction&pageNum=${paging.pageNum - 1}&metNum=${meetingVo.metNum}">Prev</a></li>
								...
								<c:if test="${paging.numOfPage != paging.pageNum}">
									<li class="page-item"><a class="page-link"
										href="meeting?command=metBoardListFormActiont&pageNum=${paging.pageNum + 1}&metNum=${meetingVo.metNum}">Next</a></li>
								</c:if>
