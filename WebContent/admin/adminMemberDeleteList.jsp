					...
					<div>
						...
						<div id="container">
							...
							<div class="tab_container">
								...
								<!-- 검색 폼 스타트 -->
								<div id="searchForm">
									<form name="frm" action="admin?command=deleteMemberAction"
								...
								<form name="frm" id="frm" method="post"
									action="admin?command=memberDelete">
										...
										<c:forEach items="${adminMemberList}" var="MemberVO"
											...
											<tbody>
												<tr style="text-align: center;">
													<td><input type="checkbox" value="${MemberVO.memNum}"
														name="memNum" id="donationMemberCheck${status.count}"></td>
													<td>${status.count}</td>
