...
<body>
	...
	<section>
		<div class="container">
			<form name="frm" action="/bookTalk?command=bookTalkUpdateAction"
				...
				<input type="hidden" name="existing_file"
					value="${bookTalk.talkFile}" />

				<div class="row" style="justify-content: center;">
					<div class="col-lg-12">
						<h4 class="text-center mb-4">얼토당토 북토크 수정</h4>

						<div class="row">
							<div class="form-group col-md-12">
								<span>도서명<span style="color: red;">*</span></span> <input
									type="text" class="form-control" placeholder="도서명을 입력하세요."
									name="talkName" value="${bookTalk.talkName}">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<span class="form-group">저자<span style="color: red;">*</span><input type="text"
									class="form-control" placeholder="저자를 입력하세요." name="writer"
									value="${bookTalk.writer}"></span>
							</div>
							<div class="col-md-6">
								<span class="form-group">출판사<span style="color: red;">*</span><input type="text"
									class="form-control" placeholder="출판사를 입력하세요."
									name="talkPublisher" value="${bookTalk.talkPublisher}"></span>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<span class="form-group">모임 일자<span style="color: red;">*</span>
									...
									placeholder="모임 일자를 선택하세요." name="talkDate"
									style="background: white;" value="${bookTalk.talkDate}">
							...
							<div class="col-md-6">
								<span class="form-group">장소 <input type="text"
									class="form-control" placeholder="장소를 입력하세요." name="talkPlace"
									value="${bookTalk.talkPlace}"></span>
							</div>
						</div>
							...
							<div class="col-md-12" style="min-height: 480px;">
								...
								<div class="wrap">
									<textarea cols="40" rows="20" name="talkContents"
										...
										placeholder="내용을 입력하세요. 글자 수는 3000자로 제한됩니다.">${bookTalk.talkContents}</textarea>
						...
						<div class="row">
							<div class="col-md-12">
								<span class="form-group">관련 기사<input type="text"
									class="form-control" placeholder="관련 기사 URL" name="articleURL"
									value="${bookTalk.articleURL}"></span>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<span class="form-group">관련 영상<input type="text"
									class="form-control" placeholder="동영상 URL" name="videoURL"
									value="${bookTalk.videoURL}"></span>
							</div>
						</div>

						<c:if test="${!empty bookTalk.talkFile}">
							<span class="form-group">기존 파일</span>
							<input name="talkFile" class="form-control"
								value="${bookTalk.talkFile}" readonly="readonly">
						</c:if>
						<span class="form-group">첨부 파일</span> <input type="file"
							name="talkFile" class="form-control-file">
				...
				<div align="right">
					<input type="submit" class="btn btn-grad" value="수정"
						onclick="return bookTalkCheck()"> <input type="button"
