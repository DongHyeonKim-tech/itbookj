(function() {
	...
	function ScheduleTemplate( element ) {
		...
		this.modalEventDetails = this.modal.getElementsByClassName('cd-schedule-modal__details')[0];
		this.modalEventIntro = this.modal.getElementsByClassName('cd-schedule-modal__intro')[0];
		this.modalEventImage = this.modal.getElementsByClassName('sm_img')[0];
		this.modalEventSns = this.modal.getElementsByClassName('cd-schedule-modal__sns')[0];
		this.modalEventIntro2 = this.modal.getElementsByClassName('cd-schedule-modal__intro2')[0];

		// this.coverLayer = this.element.getElementsByClassName('cd-schedule__cover-layer')[0];
		this.coverLayer = this.element.getElementsByClassName('sm_overlay')[0];
		this.sm_modal_mobile = this.element.getElementsByClassName('sm_modal_mobile')[0];
		this.sm_modal_mobile_header = this.element.getElementsByClassName('sm_modal_mobile_header')[0];
		this.sm_modal_mobile__name = this.element.getElementsByClassName('sm_modal_mobile__name')[0];
		this.sm_modal_mobile_close = this.element.getElementsByClassName('sm_modal_mobile_close')[0];
		this.sm_mobile_modal_img = this.element.getElementsByClassName('sm_mobile_modal_img')[0];
		this.sm_modal_mobile__date = this.element.getElementsByClassName('sm_modal_mobile__date')[0];
		this.sm_modal_mobile__details = this.element.getElementsByClassName('sm_modal_mobile__details')[0];
		this.sm_modal_mobile__intro = this.element.getElementsByClassName('sm_modal_mobile__intro')[0];
		this.sm_modal_mobile__sns = this.element.getElementsByClassName('sm_modal_mobile__sns')[0];
	...
	ScheduleTemplate.prototype.initEvents = function() {
		...
		//close modal window
		this.sm_modal_mobile_close.addEventListener('click', function(event){
			event.preventDefault();
			self.closeModal();
		});
	...
	ScheduleTemplate.prototype.openModal = function(target) {
		...
		this.modalEventDetails.textContent = target.getElementsByTagName('em')[1].textContent;
		this.modalEventIntro.textContent = target.getElementsByTagName('em')[2].textContent;
		this.modalEventSns.textContent = target.getElementsByTagName('em')[3].textContent;
		this.modalEventImage.src = target.getElementsByTagName('img')[0].src;
		this.modalEventIntro2.textContent = target.getElementsByTagName('em')[4].textContent;


		this.sm_modal = target.parentNode;

		this.modalEventIntro.hidden = false;
		this.modalEventSns.hidden = false;
		this.modalEventImage.hidden = false;
		this.modalEventIntro2.hidden = false;
		
		this.coverLayer.hidden = false;
		...
		if( mq == 'mobile' ) {
			self.sm_modal_mobile.hidden = false;
			self.modal.hidden = true;
			self.animating = false;

			self.sm_modal_mobile__name.textContent = this.modalEventName.textContent;
			self.sm_mobile_modal_img.src =  this.modalEventImage.src;
			self.sm_modal_mobile__date.textContent = this.modalDate.textContent;
			self.sm_modal_mobile__details.textContent = this.modalEventDetails.textContent;
			self.sm_modal_mobile__intro.textContent = this.modalEventIntro.textContent;	
			self.sm_modal_mobile__sns.textContent = this.modalEventSns.textContent;	


			self.sm_modal_mobile_header.classList.remove('sm_color1');
			self.sm_modal_mobile_header.classList.remove('sm_color2');
			self.sm_modal_mobile_header.classList.remove('sm_color3');
			self.sm_modal_mobile_header.classList.remove('sm_color4');
			self.sm_modal_mobile_header.classList.remove('sm_color5');
			self.sm_modal_mobile_header.classList.add('sm_color'+target.parentNode.getAttribute('sm_color'));


		} else {
			self.sm_modal_mobile.hidden = true;
			self.modal.hidden = false;

			var eventPosition = target.getBoundingClientRect(),
				eventTop = parseInt(this.sm_modal.style.top)+50, //target.offsetHeight, //eventPosition.top,
				eventLeft = this.sm_modal.getBoundingClientRect()['width']*parseInt(Array.prototype.indexOf.call(this.sm_modal.parentNode.parentNode.parentElement.children, this.sm_modal.parentNode.parentNode)) + 60 , //target.offsetWidth, //eventPosition.left,
			...
			var modalTranslateX = parseInt((modalWidth)/2 - eventLeft),
				modalTranslateY = parseInt((modalHeight)/2 - eventTop);
			...
			self.modalHeaderBg.classList.remove('sm_color1');
			self.modalHeaderBg.classList.remove('sm_color2');
			self.modalHeaderBg.classList.remove('sm_color3');
			self.modalHeaderBg.classList.remove('sm_color4');
			self.modalHeaderBg.classList.remove('sm_color5');
			self.modalHeaderBg.classList.add('sm_color'+target.parentNode.getAttribute('sm_color'));
	...
	ScheduleTemplate.prototype.closeModal = function () {
		...
		this.modalEventIntro.hidden = true;
		this.modalEventSns.hidden = true;
		this.modalEventImage.hidden = true;
		this.modalEventIntro2.hidden = true;
		this.coverLayer.hidden = true;
